...
static const _Cmd_Request_type_support_symbol_names_t _Cmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, action_interface, srv, Cmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_interface, srv, Cmd_Request)),
  }
};
...
{
  return &::action_interface::srv::rosidl_typesupport_cpp::Cmd_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, action_interface, srv, Cmd_Request)() {
  return get_message_type_support_handle<action_interface::srv::Cmd_Request>();
}
...
static const _Cmd_Response_type_support_symbol_names_t _Cmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, action_interface, srv, Cmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_interface, srv, Cmd_Response)),
  }
};
...
{
  return &::action_interface::srv::rosidl_typesupport_cpp::Cmd_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, action_interface, srv, Cmd_Response)() {
  return get_message_type_support_handle<action_interface::srv::Cmd_Response>();
}
...
static const _Cmd_type_support_symbol_names_t _Cmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, action_interface, srv, Cmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_interface, srv, Cmd)),
  }
};
...
{
  return &::action_interface::srv::rosidl_typesupport_cpp::Cmd_service_type_support_handle;
}
