...
#include <memory>
#include "../../../../src/cw_serv/include/cw_serv/modules/ServerParts/TCPClient.hpp"
...
QT_MOC_LITERAL(1, 10, 9), // "LogClient"
...
QT_MOC_LITERAL(8, 82, 15), // "ParsedNewPacket"
QT_MOC_LITERAL(9, 98, 7), // "Packet*"
QT_MOC_LITERAL(10, 106, 6) // "packet"

    },
    "TCPClient\0LogClient\0\0std::string\0"
    "message\0levelLog\0SendMessageToServer\0"
    "ReadMessage\0ParsedNewPacket\0Packet*\0"
    "packet"
};
...
void TCPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->ParsedNewPacket((*reinterpret_cast< Packet*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TCPClient::*)(const std::string & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPClient::LogClient)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPClient::SendMessageToServer)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TCPClient::LogClient(const std::string & _t1, int _t2)
{
...
// SIGNAL 1
void TCPClient::SendMessageToServer(const QJsonObject & _t1)
{
